...
#        FOPTIONS   += -LANG:heap_allocation_threshold=0
      ...
      ifeq ($(_CC),pgcc)
        ...
        # NEED TO COMMENT OUT GNU OPTIONS SINCE THIS IS THE "ELSE" FOR COPTIONS
        COPTIONS   =   -O3 #-funroll-loops -ffast-math  
      endif
      ifdef USE_GCC34
...
#   EXTRA_LIBS += -ltk -ltcl -L/usr/X11R6/lib -lX11 -ldl
     EXTRA_LIBS += -lnwcutil  -lpthread -lutil -ldl -lssl
...
#for BGP
   ...
   ifeq ($(FC),$(findstring $(FC),bgxlf bgxlf_r mpixlf77 mpixlf77_r))
